...
def login(mkt_cookie_value,adm_cookie_value):
    ...
    if login == user[0][0] and check(pwhash=user[0][1],password=password) == True and user[0][2] == 1: # marketing
        ...
        ui = make_response(dedent(marketing_ui)) # intégration d'un cookie d'authentification temporaire suite à l'authentification en marketing
    ...
    if login == user[0][0] and check(pwhash=user[0][1],password=password) == True and user[0][2] == 0: # accès marketing bloqué
        ...
        ui = make_response(dedent(administrateur_ui)) # intégration d'un cookie d'authentification temporaire suite à l'authentification en administrateur
