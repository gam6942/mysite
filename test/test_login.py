...
def login(login_data,password_data,switch):
    ...
    if login == user[1][0] and check(pwhash=user[1][1],password=password) == True: # administrateur
        ...
        return dedent(administrateur_ui)
...
class TestLogin(unittest.TestCase):
    ...
    def test_login(self):
        ...
        self.assertMultiLineEqual(login('marketing','marketing',1),dedent(case_1))
        self.assertMultiLineEqual(login('marketing','marketing',0),case_2)
        self.assertMultiLineEqual(login('administrateur','administrateur',1),dedent(case_3))
        self.assertMultiLineEqual(login('administrateur','administrateur',0),dedent(case_4))
